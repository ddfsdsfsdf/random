                ...
                <div class="box @if($enabled == 'true') box-success @else box-danger @endif">
                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                <label class="control-label" for="webhook">Webhook</label>
                                <select name="webhook" id="webhook" class="form-control">
                                    <option @if ($webhook == 'false') selected @endif value="false">Disabled</option>
                                    <option @if ($webhook == 'true') selected @endif value="true">Enabled</option>
                                </select>
                                <p class="text-muted"><small>Enable this to send a Discord Webhook when a user registers.</small></p>
                            </div>
                            <div class="form-group col-md-4 @if ($webhook === 'true') visible @else hidden @endif">
                                <label class="control-label" for="webhook_url">Webhook URL</label>
                                <input name="webhook_url" id="webhook_url" class="form-control" value="{{ $webhook_url }}">
                                <p class="text-muted"><small>Enable this to send a Discord Webhook when a user registers.</small></p>
                            </div>
                        </div>
                    </div>
